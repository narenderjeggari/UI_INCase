...
export default function AutosetWeeklyWorkSearchRequirements() {
      ...
      case "program":
        return (
          <Typography
            ...
            onClick={() => {
              fetchParamDetails(row.wsccId, false);
            }}
          >
            {value}
          </Typography>
    ...
    try {
      const response =
        process.env.REACT_APP_ENV === "mockserver"
          ? await client.get(`${otherConfigWorkSearchReqURL}`)
          : await client.post(`${otherConfigWorkSearchReqURL}`, payload);
      setData(response.wsccSummaryList);
  ...
  const deletParam = async () => {
    ...
    try {
      const response =
        process.env.REACT_APP_ENV === "mockserver"
          ? await client.get(`${otherConfigWorkSearchReqDeleteURL}`)
          : await client.delete(
              `${otherConfigWorkSearchReqDeleteURL}${selectedParamIdForDelete}`
            );
  ...
  return (
    <>
                                ...
                                <Tooltip title="Edit" placement="left">
                                  <IconButton disabled={!isUpdateAccessExist()}>
                                    <EditNoteIcon
                                      ...
                                      onClick={(event) => {
                                        fetchParamDetails(row.wsccId, true);
                                        event.preventDefault();
                                        event.stopPropagation();
                                      }}
                                    />
      ...
      <CustomModal
        ...
        title="View Minimum Weekly Work Search Requirement Configuration"
        maxWidth="lg"
      >
        <DialogContent>
          <Stack mt={3}>
      ...
      <CustomModal
        ...
        aria-labelledby="modal-modal-title"
        aria-describedby="modal-modal-description"
        title="Edit Minimum Weekly Work Search Requirement Configuration"
        maxWidth="lg"
      >
      ...
      <CustomModal
        ...
        aria-labelledby="modal-modal-title"
        aria-describedby="modal-modal-description"
        title="Delete Work Search Requirement Param"
      >
        <DialogContent>
          <Stack
            width="100%"
