...
export default function AutosetWeeklyWorkSearchWaivers() {
    ...
    try {
      const response =
        process.env.REACT_APP_ENV === "mockserver"
          ? await client.get(`${otherConfigWorkSearchWaiversURL}`)
          : await client.post(`${otherConfigWorkSearchWaiversURL}`, payload);
