...
export default function InvesticaseSpideringEvents() {
  ...
  const showDeleteParamDialog = (event, speId) => {
    setSelectedParamIdForDelete(speId);
  ...
  const deletParam = async () => {
    ...
    try {
      const response =
        process.env.REACT_APP_ENV === "mockserver"
          ? await client.get(`${otherConfigInvesticaseSpideringEventsDeleteURL}`)
          : await client.delete(
              `${otherConfigInvesticaseSpideringEventsDeleteURL}${selectedParamIdForDelete}`
            );
  ...
  return (
    <>
                                ...
                                <Tooltip title="Edit" placement="left">
                                  <IconButton disabled={false}>
                                    <EditNoteIcon
                                      ...
                                      onClick={(event) => {
                                        fetchParamDetails(row.speId, true);
                                        event.preventDefault();
                                        event.stopPropagation();
                                      }}
                                    />
                              ...
                              {row.deleteFlag === true ? (
                                <Tooltip title="Delete" placement="right">
                                  <IconButton disabled={!isUpdateAccessExist()}>
                                    <DeleteForeverIcon
                                      onClick={(event) => {
                                        showDeleteParamDialog(event, row.speId);
                                      }}
                                      sx={{ cursor: "pointer" }}
                                      fontSize="medium"
                                      {...(isUpdateAccessExist() && {
      ...
      <CustomModal
        ...
        aria-labelledby="modal-modal-title"
        aria-describedby="modal-modal-description"
        title="Edit Spidering Events Configuration"
        maxWidth="lg"
      >
